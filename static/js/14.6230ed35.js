"use strict";
(self["webpackChunkmodern_js_deploy_csr"] = self["webpackChunkmodern_js_deploy_csr"] || []).push([["14"], {
10592: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  Ol: () => (createAsyncInterruptHook),
  rG: () => (createCollectSyncHook),
  y2: () => (createSyncHook)
});
/* ESM import */var _swc_helpers_async_to_generator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(34902);
/* ESM import */var _swc_helpers_to_consumable_array__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(88511);
/* ESM import */var _swc_helpers_ts_generator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9787);
...
function createAsyncInterruptHook() {
  ...
  var call = function() {
    var _ref = (0,_swc_helpers_async_to_generator__WEBPACK_IMPORTED_MODULE_0__._)(function() {
      ...
      return (0,_swc_helpers_ts_generator__WEBPACK_IMPORTED_MODULE_1__/* .__generator */.Jh)(this, function(_state) {
        switch (_state.label) {
          case 0:
...
/* ESM import */var _swc_helpers_define_property__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(40833);
/* ESM import */var _swc_helpers_to_consumable_array__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(88511);
/* ESM import */var _swc_helpers_type_of__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(61999);
...
var core_context = __webpack_require__(30995);
...
var runtime = __webpack_require__(39714);
...
function wrapRuntimeContextProvider(App, contextValue) {
  return /* @__PURE__ */ react.createElement(runtime/* RuntimeReactContext,Provider */.JO.Provider, {
    value: contextValue
  }, App);
}
...
// EXTERNAL MODULE: ./node_modules/.pnpm/@modern-js+runtime@2.67.1_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@modern-js/runtime/dist/esm/core/constants.js
var constants = __webpack_require__(17844);
...
function hydrateRoot(App, context, ModernRender, ModernHydrate) {
  ...
  var hydrateContext = (0,_object_spread_props._)((0,_object_spread._)({}, context), {
    get routes() {
  ...
  var renderLevel = ((_window = window) === null || _window === void 0 ? void 0 : (_window__SSR_DATA = _window._SSR_DATA) === null || _window__SSR_DATA === void 0 ? void 0 : _window__SSR_DATA.renderLevel) || constants/* RenderLevel,CLIENT_RENDER */.Nm.CLIENT_RENDER;
  ...
  function streamSSRHydrate() {
    if (renderLevel === constants/* RenderLevel,SERVER_RENDER */.Nm.SERVER_RENDER) {
      var SSRApp = function() {
  ...
  function stringSSRHydrate() {
    if (renderLevel === constants/* RenderLevel,CLIENT_RENDER */.Nm.CLIENT_RENDER || renderLevel === constants/* RenderLevel,SERVER_PREFETCH */.Nm.SERVER_PREFETCH) {
      return ModernRender(wrapRuntimeContextProvider(App, context));
    } else if (renderLevel === constants/* RenderLevel,SERVER_RENDER */.Nm.SERVER_RENDER) {
      return new Promise(function(resolve) {
        if (isReact18()) {
...
var getQuery = function() {
  return window.location.search.substring(1).split("&").reduce(function(res, item) {
    var _item_split = (0,_sliced_to_array._)(item.split("="), 2), key = _item_split[0], value = _item_split[1];
    if (key) {
      res[key] = value;
    }
    return res;
...
function getSSRData() {
  ...
  var finalSSRData = (0,_object_spread_props._)((0,_object_spread._)({}, ssrData || {
    renderLevel: 0,
    mode: "string"
  }), {
    context: (0,_object_spread_props._)((0,_object_spread._)({}, (ssrData === null || ssrData === void 0 ? void 0 : ssrData.context) || {}), {
      request: (0,_object_spread_props._)((0,_object_spread._)({}, (ssrData === null || ssrData === void 0 ? void 0 : (_ssrData_context1 = ssrData.context) === null || _ssrData_context1 === void 0 ? void 0 : _ssrData_context1.request) || {}), {
        ...
        query: (0,_object_spread._)({}, getQuery(), (ssrRequest === null || ssrRequest === void 0 ? void 0 : ssrRequest.query) || {}),
        url: location.href
      })
    })
  });
...
function isClientArgs(id) {
  return typeof id === "undefined" || typeof id === "string" || typeof HTMLElement !== "undefined" && (0,_instanceof._)(id, HTMLElement);
}
function core_browser_render(App, id) {
  return browser_render.apply(this, arguments);
}
function browser_render() {
  browser_render = (0,_async_to_generator._)(function(App, id) {
    ...
    function _ModernRender() {
      _ModernRender = (0,_async_to_generator._)(function(App2) {
        var renderFunc;
    ...
    function _ModernHydrate() {
      _ModernHydrate = (0,_async_to_generator._)(function(App2, callback) {
        var hydrateFunc;
        return (0,tslib_es6/* __generator */.Jh)(this, function(_state) {
    ...
    return (0,tslib_es6/* __generator */.Jh)(this, function(_state) {
      switch (_state.label) {
        case 0:
          context = (0,runtime/* getInitialContext */.zv)();
          runBeforeRender = function() {
            var _ref = (0,_async_to_generator._)(function(context2) {
              var internalRuntimeContext, api, hooks, init;
              return (0,tslib_es6/* __generator */.Jh)(this, function(_state2) {
                switch (_state2.label) {
                  case 0:
                    internalRuntimeContext = (0,core_context/* getGlobalInternalRuntimeContext */.Uk)();
                  ...
                  case 1:
                    _state2.sent();
                    init = (0,core_context/* getGlobalAppInit */.Hb)();
                    return [
                      2,
...
function _renderWithReact18() {
  _renderWithReact18 = (0,_async_to_generator._)(function(App, rootElement) {
    var ReactDOM, root;
    return (0,tslib_es6/* __generator */.Jh)(this, function(_state) {
      switch (_state.label) {
        case 0:
...
function _renderWithReact17() {
  _renderWithReact17 = (0,_async_to_generator._)(function(App, rootElement) {
    var ReactDOM;
    return (0,tslib_es6/* __generator */.Jh)(this, function(_state) {
      switch (_state.label) {
        case 0:
...
function _hydrateWithReact18() {
  _hydrateWithReact18 = (0,_async_to_generator._)(function(App, rootElement) {
    var ReactDOM, root;
    return (0,tslib_es6/* __generator */.Jh)(this, function(_state) {
      switch (_state.label) {
        case 0:
...
function _hydrateWithReact17() {
  _hydrateWithReact17 = (0,_async_to_generator._)(function(App, rootElement, callback) {
    var ReactDOM, root;
    return (0,tslib_es6/* __generator */.Jh)(this, function(_state) {
      switch (_state.label) {
        case 0:
...
30995: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  CH: () => (getGlobalLayoutApp),
  FM: () => (getGlobalApp),
  Hb: () => (getGlobalAppInit),
  Uk: () => (getGlobalInternalRuntimeContext),
  cE: () => (setGlobalContext),
  hb: () => (setGlobalInternalRuntimeContext),
  jn: () => (getGlobalRoutes),
  nB: () => (getGlobalAppConfig),
  te: () => (getCurrentEntryName)
});
...
49903: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  v: () => (/* binding */ registerPlugin),
  f: () => (/* binding */ mergeConfig)
});

// EXTERNAL MODULE: ./node_modules/.pnpm/@swc+helpers@0.5.17/node_modules/@swc/helpers/esm/_to_consumable_array.js + 3 modules
var _to_consumable_array = __webpack_require__(88511);
// EXTERNAL MODULE: ./node_modules/.pnpm/@modern-js+runtime-utils@2.67.1_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@modern-js/runtime-utils/dist/esm/merge.js
var merge = __webpack_require__(13536);
...
function initPluginAPI(param) {
  ...
  function updateRuntimeContext(updateContext) {
    context = (0,merge/* merge */.T)(context, updateContext);
  }
  function getHooks() {
    return (0,_object_spread._)({}, hooks, extendsHooks);
  }
  ...
  var pluginAPI = (0,_object_spread._)({
...
// EXTERNAL MODULE: ./node_modules/.pnpm/@swc+helpers@0.5.17/node_modules/@swc/helpers/esm/_object_spread_props.js
var _object_spread_props = __webpack_require__(92928);
// EXTERNAL MODULE: ./node_modules/.pnpm/@modern-js+plugin-v2@2.67.1_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@modern-js/plugin-v2/dist/esm/hooks.js
var esm_hooks = __webpack_require__(10592);
...
function initHooks() {
  return {
    onBeforeRender: (0,esm_hooks/* createAsyncInterruptHook */.Ol)(),
    wrapRoot: (0,esm_hooks/* createSyncHook */.y2)(),
    pickContext: (0,esm_hooks/* createSyncHook */.y2)(),
    config: (0,esm_hooks/* createCollectSyncHook */.rG)()
  };
}
...
function createRuntimeContext(param) {
  ...
  return (0,_object_spread_props._)((0,_object_spread._)({}, runtimeContext), {
    hooks: (0,_object_spread._)({}, initHooks(), extendsHooks),
    extendsHooks,
    config
  });
}
...
var createRuntime = function() {
  ...
  var run = function run2(options) {
    ...
    runtimeContext.config = merge/* merge,apply */.T.apply(void 0, [
      {}
    ].concat((0,_to_consumable_array._)(configs), [
...
function hooks_handleSetupResult(setupResult, api) {
  ...
  Object.keys(setupResult).forEach(function(key) {
    ...
    if (typeof fn === "function") {
      ...
      if (api[newAPI]) {
        if (key === "beforeRender") {
          api[newAPI](/* @__PURE__ */ (0,_async_to_generator._)(function() {
            ...
            return (0,tslib_es6/* __generator */.Jh)(this, function(_state) {
              switch (_state.label) {
                case 0:
                  ...
                  return [
                    4,
                    fn.apply(void 0, (0,_to_consumable_array._)(params))
                  ];
                case 1:
                  _state.sent();
                  return [
          ...
          api[newAPI](function() {
            ...
            var res = fn.apply(void 0, (0,_to_consumable_array._)(params));
            return res;
          });
        }
      }
...
function getHookRunners(runtimeContext) {
  ...
  return {
    beforeRender: function() {
      var _ref = (0,_async_to_generator._)(function(context) {
        return (0,tslib_es6/* __generator */.Jh)(this, function(_state) {
          return [
            2,
...
function registerPlugin(internalPlugins, runtimeConfig) {
  ...
  var runtimeContext = runtime.run({
    ...
    ].concat((0,_to_consumable_array._)(internalPlugins), (0,_to_consumable_array._)(plugins)),
    config: runtimeConfig || {},
    handleSetupResult: hooks_handleSetupResult
  }).runtimeContext;
  (0,core_context/* setGlobalInternalRuntimeContext */.hb)(runtimeContext);
  return runtimeContext;
}
function mergeConfig(config) {
  ...
  return merge/* merge,apply */.T.apply(void 0, [
    {},
    config
  ].concat((0,_to_consumable_array._)(otherConfig)));
}



}),
83794: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  s: () => (/* binding */ createRoot)
});
...
function createRoot(UserApp) {
  var App = UserApp || (0,context/* getGlobalApp */.FM)();
  if (isBrowser()) {
    window._SSR_DATA = window._SSR_DATA || parsedJSONFromElement(constants/* SSR_DATA_JSON_ID */.pc);
    window._ROUTER_DATA = window._ROUTER_DATA || parsedJSONFromElement(constants/* ROUTER_DATA_JSON_ID */.Ni);
  }
  var internalRuntimeContext = (0,context/* getGlobalInternalRuntimeContext */.Uk)();
...
54593: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  NA: () => (/* binding */ routerPlugin)
});

// UNUSED EXPORTS: beforeCreateRouter, finalRouteConfig, modifyRoutes
...
var modifyRoutes = (0,esm_hooks/* createSyncHook */.y2)();
var onBeforeCreateRoutes = (0,esm_hooks/* createSyncHook */.y2)();
...
function createLoader(route) {
  ...
  if (loader) {
    return function() {
      var _ref = (0,_async_to_generator._)(function(args) {
  ...
  return {
    ...
    setup: function(api) {
      ...
      api.wrapRoot(function(App) {
        ...
        var _merge = (0,merge/* merge */.T)(pluginConfig.router || {}, userConfig), _merge_serverBase = _merge.serverBase, serverBase = _merge_serverBase === void 0 ? [] : _merge_serverBase, _merge_supportHtml5History = _merge.supportHtml5History, supportHtml5History = _merge_supportHtml5History === void 0 ? true : _merge_supportHtml5History, _merge_basename = _merge.basename, basename = _merge_basename === void 0 ? "" : _merge_basename, routesConfig = _merge.routesConfig, createRoutes = _merge.createRoutes, future = _merge.future;
        ...
        finalRouteConfig = (0,esm_object_spread._)({
          routes: (0,core_context/* getGlobalRoutes */.jn)(),
          globalApp: (0,core_context/* getGlobalLayoutApp */.CH)()
        }, routesConfig);
        ...
        var getRouteApp = function() {
          var useCreateRouter = function(props) {
            var runtimeContext = (0,react.useContext)(runtime/* RuntimeReactContext */.JO);
            ...
            return (0,react.useMemo)(function() {
              ...
              router.subscribe = function(listener) {
                var wrapedListener = function() {
                  ...
                  return listener.apply(void 0, (0,_to_consumable_array._)(args));
                };
...
9255: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  UC: () => (handleRouteModuleError),
  u3: () => (handleRouteModule)
});
/* ESM import */var _modern_js_utils_universal_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(29952);
...
var handleRouteModule = function(routeModule, routeId) {
  if (typeof document !== "undefined") {
    window[_modern_js_utils_universal_constants__WEBPACK_IMPORTED_MODULE_0__/* .ROUTE_MODULES */.u$][routeId] = routeModule;
  }
  return routeModule;
};
