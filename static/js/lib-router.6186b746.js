...
__webpack_require__.d(__webpack_exports__, {
  ...
  WS: () => (convertRouteMatchToUiMatch),
  X3: () => (AbortedDeferredError),
  Zn: () => (stripBasename),
  aU: () => (Action),
  cP: () => (parsePath),
  cm: () => (getResolveToMatches),
  fp: () => (matchRoutes),
  lX: () => (createBrowserHistory),
  p7: () => (createRouter),
  pC: () => (resolveTo),
  q_: () => (createHashHistory)
});
/* ESM import */var _swc_helpers_async_to_generator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(34902);
/* ESM import */var _swc_helpers_type_of__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(61999);
/**
...
function createStaticHandler(routes, opts) {
   ...
   */ _async_to_generator(function*(request, _temp4) {
    ...
    function _queryImpl() {
        _queryImpl = _async_to_generator(function*(request, location, matches, requestContext, dataStrategy, skipLoaderErrorBubbling, routeMatch) {
    ...
    function _submit() {
        _submit = _async_to_generator(function*(request, matches, actionMatch, requestContext, dataStrategy, skipLoaderErrorBubbling, isRouteRequest) {
            var result;
            if (!actionMatch.route.action && !actionMatch.route.lazy) {
                var error = getInternalRouterError(405, {
                    method: request.method,
    ...
    function _loadRouteData() {
        _loadRouteData = _async_to_generator(function*(request, matches, requestContext, dataStrategy, skipLoaderErrorBubbling, routeMatch, pendingActionResult) {
    ...
    function _callDataStrategy() {
        ...
        // pass around the manifest, mapRouteProperties, etc.
        _async_to_generator(function*(type, request, matchesToLoad, matches, isRouteRequest, requestContext, dataStrategy) {
            ...
            yield Promise.all(matches.map(/*#__PURE__*/ function() {
                var _ref = _async_to_generator(function*(match) {
...
37541: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* ESM import */var react_dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(30967);
/* ESM import */var react_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(92564);
/* ESM import */var _remix_run_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(13252);
/**
 ...
 */ var Form = /*#__PURE__*/ (/* unused pure expression or super */ null && (React.forwardRef((_ref9, forwardedRef)=>{
...
var savedScrollPositions = (/* unused pure expression or super */ null && ({}));
/**
...
92564: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
var react__WEBPACK_IMPORTED_MODULE_0___namespace_cache;
__webpack_require__.d(__webpack_exports__, {
  AW: () => (Route),
  DY: () => (useRoutesImpl),
...
/* ESM import */var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(75271);
/* ESM import */var _remix_run_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13252);
/**
 ...
 */ function useHref(to, _temp) {
    ...
    if (basename !== "/") {
        joinedPathname = pathname === "/" ? basename : (0,_remix_run_router__WEBPACK_IMPORTED_MODULE_1__/* .joinPaths */.RQ)([
            basename,
            pathname
        ]);
    }
 ...
 */ function useMatches() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0__.useMemo(()=>matches.map((m)=>(0,_remix_run_router__WEBPACK_IMPORTED_MODULE_1__/* .UNSAFE_convertRouteMatchToUiMatch */.WS)(m, loaderData)), [
        matches,
        loaderData
    ]);
}
 ...
 */ function Navigate(_ref4) {
    ...
    !useInRouterContext() ?  false ? 0 : UNSAFE_invariant(false) : void 0;
    var { future, static: isStatic } = React.useContext(NavigationContext);
     false ? 0 : void 0;
    var { matches } = React.useContext(RouteContext);
    var { pathname: locationPathname } = useLocation();
    var navigate = useNavigate();
 ...
 */ function Router(_ref5) {
    var { basename: basenameProp = "/", children = null, location: locationProp, navigationType = _remix_run_router__WEBPACK_IMPORTED_MODULE_1__/* .Action.Pop */.aU.Pop, navigator, static: staticProp = false, future } = _ref5;
    !!useInRouterContext() ?  false ? 0 : (0,_remix_run_router__WEBPACK_IMPORTED_MODULE_1__/* .UNSAFE_invariant */.J0)(false) : void 0;
